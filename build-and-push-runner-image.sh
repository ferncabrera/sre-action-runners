...
docker build --build-arg RUNNER_VERSION="$RUNNER_VERSION" -t fcabrera01/actions-image -t fcabrera01/actions-image:v${RUNNER_VERSION} .

docker push fcabrera01/actions-image:latest
